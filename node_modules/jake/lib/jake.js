...
if (!global.jake) {
  ...
  const ROOT_NAMESPACE_NAME = Namespace.ROOT_NAMESPACE_NAME;
  ...
  Object.assign(jake, new (function () {
    ...
    this.rootNamespace = new Namespace(ROOT_NAMESPACE_NAME, null);
    ...
    this.createTask = function () {
      ...
      // Create task -> namespace linkage
      // (See inverse created below)
      opts.namespace = jake.currentNamespace;
      switch (type) {
      case 'directory':
        action = function () {
          jake.mkdirP(name);
